...
$sql = "UPDATE `cliente` SET `nomeCliente`='$nomeCliente', `cpfCliente`=$cpfCliente,`cepCliente`=$cepCliente,`ederecoCliente`='$ederecoCliente',`telefoneCliente`=$telefoneCliente WHERE idCliente = $id";
